...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		try {
			...
			if (session.getAttribute("dnad") == null) {
				...
				ArrayList<hoadonbean> dshdcm = hdbo.GetHDChuaMua();

				request.setAttribute("dshdcm", dshdcm);
				RequestDispatcher rd = request.getRequestDispatcher("AdminXacNhanDonHang.jsp");
