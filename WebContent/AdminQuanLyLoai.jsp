...
<body>
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="AdminQuanLyLoaiController">Quản
	...
	<div class="box">
		<button type="button" class="btn btn-primary back-btn">
			<a href="AdminThemLoaiController" style="color: #fff;">Thêm loại</a>
		</button>
		<div class="container">
			<table class="table table-bordered table-striped">
				...
				<c:choose>
					<c:when test="${dsloai != null}">
						<c:forEach var="s" items="${dsloai}">
							<tr style="background-color: #1b1e1f;">
								<td class="text-center">${s.getMaloai() }</td>
								<td class="text-center">${s.getTenloai() }</td>
								<td class="text-center">
									<button type="button" class="btn btn-success">
										<a style="color: #fff;"
											href="AdminSuaLoaiController?ml=${s.getMaloai() }"> <span
											class="glyphicon glyphicon-th-list"></span>
										</a>
									</button>
									<button type="button" class="btn btn-danger">
										<a style="color: #fff;"
											href="AdminXoaLoaiController?ml=${s.getMaloai() }"> <span
	...
	<div class="overlay">
		<div class="er-box">
			<h4>Lỗi! Mã này tồn tại sản phẩm</h4>
			<btn class="btn btn-success"> 
				<a href="AdminQuanLyLoaiController?noterr=1">OK</a>
			</btn>
		</div>
	</div>
	</c:if>
