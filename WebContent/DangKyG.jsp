...
<body>
	...
	<div class="form-sign-in">
		<form action="DangKyControllerG" method="post" class="form-in">
			<div class="close">
				<a href="TrangChuController"> <span
					class="glyphicon glyphicon-remove"></span>
				</a>
			</div>
			<h3>Sign Up</h3>
			<div class="input-box">
				<span>Họ tên</span> <input name="ht" type="text">
			</div>
			<div class="input-box">
				<span>Địa chỉ</span> <input name="dc" type="text">
			</div>
			<div class="input-box">
				<span>Số điện thoại</span> <input name="sdt" type="text">
			</div>
			<div class="input-box">
