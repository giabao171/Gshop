		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="AdminXacNhanDonHangController">Xác nhận đơn
						hàng</a></li>
				<li class="active"><a href="AdminLichSuGiaoDichController">Lịch
						sử giao dịch đơn hàng</a></li>
			</ul>
	...
	<div class="box">
		<div class="container">
			<table class="table table-bordered table-striped">
				...
				<c:choose>
					<c:when test="${dshddm != null}">
						<c:forEach var="s" items="${dshddm}">
							<tr style="background-color: #1b1e1f;">
								...
								<td class="text-center" style="color: #5cb85c;">Đã nhận</td>
								<td class="text-center">
									<button type="button" class="btn btn-success">
										<a
											href="AdminChiTietGiaoDichController?mhd=${s.getMahoadon() }">
